...
## challenge II [force this to be near the start of the skill tree]
...
*Looped Knowledge*
(JoyTheBard (OW): increase `progression_balancing` by 25) [hint by Deathclaw99!]

JoyTheBard (OW): increase `progression_balancing` by 25
Broney (SM): increase `progression_balancing` by 25
Broney (Angband): increase `progression_balancing` by 10
rhythm.Belius/Terakomari: increase `progression_balancing` by varying amounts
MiroRogue (DLCQ): increase `progression_balancing` by 33
Broney (Angband): increase `progression_balancing` by 10
...
(Toto (StS): "Card Draw" x 2 [Not from pool])

Toto (StS): "Card Draw" [Not from pool]
Toto (StS): "Card Draw" [Not from pool]
Toto (StS): "Card Draw" [Not from pool]
Toto (StS): "Card Draw" [Not from pool]
Toto (StS): "Card Draw" [Not from pool]
...
Toto (StS): "Rare Card Draw" [Not from pool]
...
Toto (StS): "Rare Card Draw" [Not from pool]
HPfunman (StS): Rare Card Draw
HPfunman (StS): Rare Card Draw

## rest I [force this to be near the end of the skill tree]
...
DiStegRogue (Emerald): Exp. Share
Connor (TS): increase `extra_earrings_xp` by 12
Toto (DS3): increase `min_levels_in_10` to 1
SunCat (Emerald): increase `match_trainer_levels_bonus`
Caesius (Emerald): "Rare Candy"
...
Sylsko (TS): Galaxy Earrings
MiroRogue (TS): "Galaxy Earrings"
SunCat (Emerald): increase `match_trainer_levels_bonus`
SunCat (Emerald): increase `match_trainer_levels_bonus`
Toto (DS3): increase `max_levels_in_5`
Toto (DS3): increase `max_levels_in_5`

## XP III

*you won't have to spend as much for your weapon to become as strong as it can.*
(Toto (DS3): increase `max_levels_in_10` by 5)

Toto (DS3): increase `max_levels_in_10` by 5
jf-rogue (TS): "Galaxy Earrings"
SunCat (TS): "Galaxy Earrings"
superfid (Secret of Evermore): increase `exp_modifier`
SunCat (Emerald): increase `match_trainer_levels_bonus`

## XP IV

*they'll get the hang of fights really quickly.*
(DiStegRogue (RB): increase `exp_modifier` by 16)

DiStegRogue (RB): increase `exp_modifier` by 16
DragoRogue2 (Red & Blue): increase `exp_modifier`
Brynatron (SDV): change `experience_multiplier` to `random-range-middle-100-400`
MiroRogue (Emerald): increase `match_trainer_levels_bonus` by 5
SunCat (TS): increase `ExtraEarringsXP` by 6

## XP V

*miracle grow but for prepubescent multiverse saviors*
(HPfunman (Kingdom Hearts): double `exp_modifier`) [hint by Joy the Bard!]

HPfunman (Kingdom Hearts): double `exp_modifier`
SunCat (Emerald): increase `match_trainer_levels_bonus`
MiroRogue (Emerald): "Exp. Share"
sheen (KH:BBS): EXP Walker
MiroRogue (Emerald): increase `exp_modifier` by 100

## XP VI

*treats without a trick.*
(Caesius (Emerald): "Rare Candy") [hint by DiStegro!]
...
*Nebula Accessory*
(superfid (TS): "Galaxy Earrings") [hint by Deathclaw99!]
...
(Caesius (TS): "Galaxy Earrings") [hint by DiStegro!]

Caesius (TS): "Galaxy Earrings"
MiroRogue (Emerald): increase `match_trainer_levels_bonus` by 5
sheen (KH:BBS): increase `exp_multiplier`
SunCat (TS): increase `ExtraEarringsXP` by 6

## XP IX

*Faster Rounds*
(superfid (TS): increase `extra_earrings_xp` lower bound) [hint by Deathclaw99!]

superfid (TS): increase `extra_earrings_xp` lower bound
SunCat (TS): increase `ExtraEarringsXP` by 6
SansEmeraldRL: increase `exp_modifier`
DragoRogue2 (Earthbound): increase `exp_modifier` by 80

## XP X

*Lucky Egg*
(superfid (Secret of Evermore): increase `exp_modifier`) [hint by Deathclaw99!]

superfid (Secret of Evermore): increase `exp_modifier`
DiStegRogue (Emerald): increase `match_trainer_levels_bonus` by 10
sheen (KH:BBS): increase `exp_multiplier`
SansEmeraldRL: increase `exp_modifier`
...
*Promise Charm*
(SansEmeraldRL: increase `exp_modifier`) [hint by Deathclaw99!]
...
*Generation 6*
(SansEmeraldRL: "Exp. Share") [hint by Deathclaw99!]
...
(Connor (TS): "Galaxy Earrings") [hint by Joy the Bard!]

Connor (TS): "Galaxy Earrings"
Toto (DS3): increase `max_levels_in_10` by 5
Caesius (Emerald): "Rare Candy"
SunCat (Emerald): increase `match_trainer_levels_bonus`
...
(DiStegRogue (RB): Exp. All) [hint by Joy the Bard!]
...
(DiStegRogue (RB): increase `exp_modifier` by 16) [hint by Joy the Bard!]
...
DragoRogue2 (Earthbound): "Progressive Bat"
Broney (Angband): increase `star_acquire_percent` by 10
TzufRougelike (OOT): "Biggoron Sword"
...
(Toto (HK): change `RandomizeNail` to `false`) [hint by Joy the Bard!]

Toto (HK): change `RandomizeNail` to `false`
DeathclawCavern (OOT): Biggoron Sword
superfid (LTTP): "Progressive Sword"
JoyTheBard (SM64): "Kick"

## melee weapon VI

*It's dangerous to go alone.*
(superfid (LTTP): change `swordless` to `false`) [hint by ChromaNyan!]

superfid (LTTP): change `swordless` to `false`
Broney (Angband): increase `star_acquire_percent` by 10
Broney (Angband): increase `star_acquire_percent` by 10
DiStegRogue (LTTP): Progressive Sword

## melee weapon VII

*a better foil*
(Caesius (OOT): "Biggoron Sword") [hint by DiStegro!]

Caesius (OOT): "Biggoron Sword"
DragoRogue2 (Earthbound): "Progressive Fry Pan"
Maxor: Progressive Sword
Rezalex: Progressive Sword

## melee weapon VIII

*you put that thing back where you found it or so help me*
(Caesius (OOT): change `shuffle_kokiri_sword` to `false`) [hint by DiStegro!]
...
(Caesius (TS): "Star of Lachiem") [hint by DiStegro!]

Caesius (TS): "Star of Lachiem"
Brynatron (HK): Nailmaster's_Glory
DragoRogue2 (Earthbound): "Progressive Fry Pan"
MiroRogue (TS): "Star of Lachiem"

## melee weapon X

*200 Times Folded Steel*
(CrystalOOT: Biggoron Sword) [hint by Deathclaw99!]

CrystalOOT: Biggoron Sword
Brynatron (HK): Great_Slash
TzufRougelike (HK): "Mark_of_Pride"
Connor (HK): "Mark_of_Pride"

## melee weapon XI

*turns out your head is a really important thing to protect*
(DragoRogue2 (Earthbound): "Progressive Bat") [hint by Joy the Bard!]
...
(Connor (UT): change `starting_area` to easier areas)

Connor (UT): change `starting_area` to easier areas
Toto (SotM): increase `starting_items`
sheen (KH:BBS): increase `starting_worlds` by 1
RndGuy (Hollow Knight): reduce `starting_difficulty: high` weight (trigger)
...
JoyTheBard (OW): make `spawn` more reasonable

## starting III

*Hospitable Home*
(JoyTheBard (OW): make `spawn` more reasonable) [hint by Deathclaw99!]

JoyTheBard (OW): make `spawn` more reasonable
RndGuy (Blasphemous): remove harder weights for `starting_location`
sheen (KH:BBS): increase `starting_worlds` by 1
Connor (UT): change `starting_area` to easier areas
Connor (UT): change `starting_area` to easier areas
RndGuy (Blasphemous): remove harder weights for `starting_location`
...
*so cold...*
(superfid (Secret of Evermore): "30 Cryo Blast") [hint by Deathclaw99!]

superfid (Secret of Evermore): "30 Cryo Blast"
Connor (SquareMusic): "Shiva"
...
Connor (SquareMusic): "Ifrit"
Connor (SquareMusic): "Bahamut"
...
(Caesius (OOT): "Zora Tunic") [hint by DiStegro!]
...
(Sylsko (C64): change `badeline_chaser_frequency` to varying amounts)
...
(Connor (SquareMusic): "Knights of the Round")

Connor (SquareMusic): "Knights of the Round"
Sylsko (TS): reduce `EnemyRando` difficulty
rhythm.Belius/Terakomari: make `death_link_mode` more reasonable
...
(MiroRogue (MC): change `send_defeated_mobs` to `false`) [hint by ChromaNyan!]

MiroRogue (MC): change `send_defeated_mobs` to `false`
Toto (SotM): decrease `death_link: individual` weight to 1
superfid (C64): change `badeline_chaser_frequency` to be better

## army V

*You feel more lonely*
(superfid (C64): change `badeline_chaser_frequency` to be better) [hint by Deathclaw99!]
...
DragoRogue2 (Red & Blue): increase `minimum_catch_rate`
DragoRogue2 (Red & Blue): "Master Ball"
SunCat (TS): improve `LootTierDistro`
DragoRogue2 (Red & Blue): "Master Ball"
DragoRogue2 (Red & Blue): "Master Ball"
DragoRogue2 (Red & Blue): "Master Ball"
DragoRogue2 (Red & Blue): "Master Ball"
...
(Caesius (MC): "Looting III Book") [hint by DiStegro!]

Caesius (MC): "Looting III Book"
SunCat (TS): improve `LootTierDistro`
MiroRogue (MC): "Looting III Book"
DragoRogue2 (Red & Blue): "Master Ball"
DragoRogue2 (Red & Blue): increase `minimum_catch_rate`
DragoRogue2 (Red & Blue): "Master Ball"
...
*Escape Rope*
(CrystalOOT: Farore's Wind) [hint by Deathclaw99!]

CrystalOOT: Farores Wind
SunCat (Emerald): "HM02 Fly"
TzufRougelike (OOT): "Farores Wind"

## travel III

*Instant Transmission*
(Brynatron (Terraria): Reward: Rod of Discord) [hint by Deathclaw99!]
...
*Zoom*
(SansEmeraldRL: "HM02 Fly") [hint by Deathclaw99!]
...
(Maxor: reduce `item_functionality` difficulty)

Maxor: reduce `item_functionality` difficulty
Rezalex: reduce `item_functionality` difficulty
Sylsko (Astalon): change `start_with_bell` to `true`

## utility II

*an anchor.*
(Toto (StS): "Relic" [Not from pool])

Toto (StS): "Relic" [Not from pool]
Toto (DS3): change `auto_equip` and `lock_equip` to `false`
Broney (Angband): Progressive Ring Artifact
...
(Toto (StS): "Relic" [Not from pool]) [hint by Joy the Bard!]
...
(Rezalex: reduce `item_functionality` difficulty) [hint by Joy the Bard!]
...
(Sylsko (C64): increase `death_link_amnesty` by varying amounts)

Sylsko (C64): increase `death_link_amnesty` by varying amounts
RndGuy (C64): increase `death_link_amnesty`
RRRRRRogue772: increase `death_link_amnesty`
Roguinater (VVVVVV): increase `DeathLinkAmnesty`
RRRRRRogue772: increase `death_link_amnesty`
RndGuy (C64): increase `death_link_amnesty`
BennyRogue (Witness): increase `death_link_amnesty` by 1
RndGuy (C64): increase `death_link_amnesty`
DeathclawCavern (C64): increase `death_link_amnesty`
Roguinater (VVVVVV): increase `DeathLinkAmnesty`
...
RRRRRRogue772: increase `death_link_amnesty`
BennyRogue (Witness): increase `death_link_amnesty` by 1
SunCat (VVVVVV): increase `death_link_amnesty` by 3
RndGuy (C64): increase `death_link_amnesty`
JoyTheBard (Witness): increase `death_link_amnesty` by 2
SunCat (VVVVVV): increase `death_link_amnesty` by 3
RndGuy (Witness): increase weights of higher `death_link_amnesty` amounts
RRRRRRogue772: increase `death_link_amnesty`
superfid (C64): increase `death_link_amnesty`
...
SunCat (VVVVVV): increase `death_link_amnesty` by 3
Roguinater (VVVVVV): increase `DeathLinkAmnesty`
SunCat (C64): increase `death_link_amnesty`
SunCat (VVVVVV): increase `death_link_amnesty` by 3
RndGuy (Witness): increase weights of higher `death_link_amnesty` amounts
RndGuy (Witness): increase weights of higher `death_link_amnesty` amounts
SunCat (VVVVVV): increase `death_link_amnesty` by 3
...
(RndGuy (C64): increase `death_link_amnesty`) [hint by Joy the Bard!]
...
(superfid (C64): increase `death_link_amnesty`) [hint by Deathclaw99!]
...
(Caesius (Marble Blast): "Time Travel (-5s)")

Caesius (Marble Blast): "Time Travel (-5s)"
Caesius (Marble Blast): "Time Travel (-5s)"
DragoRogue2 (Factorio): increase `recipe_time`
...
sheen (Factorio): increase `recipe_time`
Caesius (Marble Blast): "Time Travel (-5s)"

## time IV

*a chance to try again*
(Caesius (Marble Blast): "Time Travel (-10s)") [hint by DiStegro!]

Caesius (Marble Blast): "Time Travel (-10s)"
Caesius (Marble Blast): "Time Travel (-5s)"
jf-rogue (TS): "Max Sand"
Caesius (Marble Blast): "Time Travel (-10s)"
DragoRogue2 (Factorio): increase `recipe_time`
...
*ctrl-z*
(Caesius (Marble Blast): "Time Travel (-5s)") [hint by DiStegro!]
...
(Caesius (TS): "Max Sand") [hint by DiStegro!]
...
*FULLCLIP*
(superfid (Secret of Evermore): change `fix_infinite_ammo` to `false`) [hint by Deathclaw99!]
...
superfid (LTTP): decrease `item_pool` difficulty
Roguinater (Peggle Nights): Jimmy Lightning

## copy II

*no way i'm doing this with only eight hearts.*
(Maxor: reduce `item_pool` difficulty)

Maxor: reduce `item_pool` difficulty
MiroRogue (MC): "Infinity Book"
...
(Caesius (MC): "Infinity Book") [hint by DiStegro!]
...
(DiStegRogue (OOT): lower `damage_multiplier` amount)

DiStegRogue (OOT): lower `damage_multiplier` amount
Caesius (OOT): halve `damage_multiplier`
Rezalex: change `enemy_damage` to `default`
DeathclawCavern (OOT): halve `damage_multiplier`
...
(Caesius (OOT): halve `damage_multiplier`) [hint by DiStegro!]
...
(BennyRogue (Witness): increase `area_hint_percentage` range by 20)
...
*a thick fog.*
(hint cost decrease) [hint by DiStegro!]
...
(hint cost decrease) [hint by Joy the Bard!]
...
-5% hint cost
MiroRogue (DLCQ): add various important Packs to `start_hints`
...
(hint cost decrease) [hint by jonfunk!]
...
add `Incense` to `start_hints`
JoyTheBard (Witness): increase `hint_amount`
...
## defy death I [force this to be near the start of the skill tree]
...
*Better Delorean*
(superfid (Secret of Evermore): lower `frequired_fragments` and `available_fragments` upper bounds) [hint by Deathclaw99!]

superfid (Secret of Evermore): lower `frequired_fragments` and `available_fragments` upper bounds
...
*Fixed Machine*
(JoyTheBard (OW): change `split_translator` to `false`) [hint by Deathclaw99!]
...
(DeathclawCavern (TS): Shattered Orb) [hint by Joy the Bard!]
...
(DeathclawCavern (SM64): change `buddy_checks` to `false`) [hint by Joy the Bard!]
...
HPfunman (Kingdom Hearts): Progressive Cure
...
(sheen (Factorio): reduce `recipe_ingredients_offset` by 1) [hint by Joy the Bard!]

sheen (Factorio): reduce `recipe_ingredients_offset` by 1
HPfunman (StS): change `character` to easier characters
...
(jf-rogue (TS): change `Inverted: true` weight to 0) [hint by Joy the Bard!]
...
(Brynatron (SDV): change `friendship_multiplier` to `random-range-middle-100-400`) [hint by Joy the Bard!]

Brynatron (SDV): change `friendship_multiplier` to `random-range-middle-100-400`
rhythm.Tsuki: Artillery mortar
...
(ChromaNyan (Super Cat Tales): "Single-Use Golden Cat") [hint by ChromaNyan!]
...
*Arnold Time*
(superfid (Secret of Evermore): change `fix_atlas_glitch` to `false`) [hint by Deathclaw99!]

superfid (Secret of Evermore): change `fix_atlas_glitch` to `false`
DragoRogue2 (Factorio): reduce `max_science_pack`
...
*Cheater....*
(superfid (Secret of Evermore): change `fix_cheats` to `false`) [hint by Deathclaw99!]
...
*ew Raisins*
(superfid (Secret of Evermore): change `turdo_mode` to `false`) [hint by Deathclaw99!]
...
*Shining Sphere*
(superfid (TS): "Radiant Orb") [hint by Deathclaw99!]
...
*Looting 3*
(superfid (TS): change `fixed_drop_rate` to 100) [hint by Deathclaw99!]
...
*All the Bling*
(superfid (TS): change `start_with_jewelry_box` to `true`) [hint by Deathclaw99!]
...
*Bruce Lee*
(Brynatron (Terraria): Reward: Black Belt) [hint by Deathclaw99!]

Brynatron (Terraria): Reward: Black Belt
DragoRogue2 (Factorio): reduce `max_science_pack`
SansEmeraldRL: increase `norman_count`
rhythm.Tsuki: Repellent overcharge
...
*Fire Resistance 4*
(Brynatron (Terraria): Reward: Lava Charm) [hint by Deathclaw99!]
...
*Hungry Larvitar*
(SansEmeraldRL: change `extra_boulders` to `false`) [hint by Deathclaw99!]
...
*Finally, Earplugs*
(SansEmeraldRL: change `move_blacklist` to `["Perish Song"]`) [hint by Deathclaw99!]
...
*7/10 too much Water*
(SansEmeraldRL: change `remove_roadblocks` to `["Lilycove City Wailmer", "Route 110 Aqua Grunts"]`) [hint by Deathclaw99!]
...
*Generous Pater*
(SansEmeraldRL: increase `norman_count`) [hint by Deathclaw99!]
...
(rhythm.Tsuki: Jetpack upgrade) [hint by Joy the Bard!]
